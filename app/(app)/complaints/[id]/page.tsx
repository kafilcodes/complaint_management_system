...
export default function TicketDetailPage({ params }: TicketDetailPageProps) {
  ...
  const timelineData = ticket?.timeline?.map((event) => {
    ...
    if (event.event === "assigned" && assignedEmployee) {
      ...
      displayMessage = `Complaint assigned to technician (${firstName})`;
    }
                ...
                <Card>
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-4">
                      <div className="flex-1">
                        <h4 className="text-sm font-semibold mb-1">Reopen this Complaint?</h4>
                        <p className="text-xs text-muted-foreground">
                          This will delete the resolution data and set the Complaint status back to open.
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  >
                    <a 
                      href={`mailto:${assignedEmployee.email}?subject=${encodeURIComponent(`Complaint #${ticket.id.slice(0, 8)} - ${ticket.productName}`)}&body=${encodeURIComponent(`Hi ${assignedEmployee.name.split(' ')[0]},\n\nI'm reaching out regarding the following complaint:\n\nComplaint ID: ${ticket.id}\nProduct: ${ticket.productName}\nCustomer: ${ticket.customerName}\nStatus: ${ticket.status}\nIssue: ${ticket.issueDescription}\n\nPlease let me know if you need any additional information.\n\nBest regards`)}`}
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  This Complaint needs to be assigned to a technician
                </p>
              </CardContent>
            </Card>
          )}
          ...
          {isAdmin && ticket.status === "open" && (
            <Card>
              ...
              <CardContent className="space-y-3">
                <p className="text-sm text-muted-foreground">
                  {ticket.assignedTo 
                    ? "Reassign this Complaint to a different employee" 
                    : "Assign this Complaint to an employee"}
                </p>
      ...
      <div className="lg:hidden mt-8">
        {timelineData && timelineData.length > 0 ? (
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                No activity recorded for this complaint yet. Timeline will appear as events occur.
              </p>
            </CardContent>
          </Card>
        )}
      ...
      <AlertDialog open={showReopenDialog} onOpenChange={setShowReopenDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will delete the previous resolution records and reopen the complaint.
              The complaint will be set back to &quot;open&quot; status, just like a newly created complaint.
